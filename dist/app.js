...
var _fetchSingleUseCode = require("../modules/fetchSingleUseCode");
...
const loginRoutes = ()=>{
    new (0, _core.WFRoute)("/login").execute(()=>{
        (0, _checkMembership.membershipCheck)();
    });
};
const discountListRoutes = ()=>{
    new (0, _core.WFRoute)("/discounts-and-benefits").execute(()=>{
        (0, _checkMembership.membershipCheck)();
        const selects = new (0, _core.WFComponent)("select");
...
const discountPageRoutes = ()=>{
    new (0, _core.WFRoute)("/discount/(.*)").execute(()=>{
        ...
        const storefrontDeepLink = new (0, _core.WFComponent)('[xa-elem="storefront-deeplink"]');
        if (storefrontDeepLink) storefrontDeepLink.on('click', ()=>{
        ...
        (0, _fetchSingleUseCode.fetchSingleUseCode)();
    });
};

},{"@xatom/core":"8w4K8","../modules/checkMembership":"fAHRS","../modules/fetchSingleUseCode":"d8YOn","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"fAHRS":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const membershipCheck = ()=>{
    ...
    (0, _core.onReady)(()=>{
        try {
            ...
            let storefrontBanner = null;
            try {
                storefrontBanner = new (0, _core.WFComponent)('[xa-elem="storefront"]');
            } catch (e) {
            ...
            const membershipValid = (0, _routes.getCookie)('membershipValid') === 'true';
            ...
            const handleMembershipCheck = async (event)=>{
                if (!membershipValid) // Always show membership modal for invalid membership
                {
                    ...
                    if (event?.target && !event.target.closest('[xa-elem="storefront"]')) // For regular cards, just navigate to the URL
                    window.location.href = clickedCardUrl;
                    else if (event?.target && event.target.closest('[xa-elem="storefront"]')) {
                        // For storefront banner, redirect to storefront
                        const authUrl = decodeURIComponent((0, _routes.getCookie)('authUrl'));
                        window.open(authUrl, '_blank');
                    }
                } else if (membershipModal) {
                    membershipModal.setStyle({
                        display: "block"
                    });
                    membershipModal.addCssClass('show-modal');
            ...
            let clickedCardUrl = "";
            const parentContainer = new (0, _core.WFComponent)(".discount_list");
            ...
            if (storefrontBanner) storefrontBanner.on('click', async (e)=>{
                e.preventDefault();
                clickedCardUrl = "https://rewards.disabilityid.co.uk";
                console.log('Storefront URL:', clickedCardUrl);
                await handleMembershipCheck(e);
            });
            loginForm.onFormSubmit((data)=>{
                const ucn = (0, _routes.getCookie)('ucn') || data.ucn;
                const payload = {
                    ucn: ucn,
                    url: getRedirectUrl(),
                    redirectUrl: '',
                    membershipValid: false,
                    authUrl: (0, _routes.getCookie)('authUrl') || ''
                };
                const membershipCheck = axiosClient.post("/api/membershipCheck?mode=json", {
                    data: payload
                });
                ...
                membershipCheck.onData((data)=>{
                    if (data.membershipValid === true) {
                        (0, _routes.setCookie)('membershipValid', 'true', 1 / 24);
                        (0, _routes.setCookie)('ucn', data.ucn, 1 / 24);
                        (0, _routes.setCookie)('authUrl', encodeURIComponent(data.authUrl), 1 / 24);
                        ...
                        } else // Otherwise use the clicked card URL
                        window.location.href = clickedCardUrl;
                        membershipModal.setStyle({
                            display: "none"
                        });
                        ...
                        (0, _routes.setCookie)('membershipValid', 'false', 1 / 24);
...
},{"@xatom/axios":"JFduh","@xatom/core":"8w4K8","../routes":"fnEL6","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"JFduh":[function(require,module,exports,__globalThis) {
...
},{"a8d2c3349c87a903":"gRR53","./helpers/bind.js":"1RCyB","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"gRR53":[function(require,module,exports,__globalThis) {
...
},{}],"1RCyB":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}],"d8YOn":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const fetchSingleUseCode = ()=>{
    ...
    codeSections.forEach((section)=>{
        ...
        const fetchSuc = (e)=>{
            ...
            let ucnValue = (0, _routes.getCookie)('ucn');
            const ucn = ucnValue;
...
},{"@xatom/axios":"JFduh","@xatom/core":"8w4K8","../routes":"fnEL6","@parcel/transformer-js/src/esmodule-helpers.js":"5oERU"}]},["jeTtx"], "jeTtx", "parcelRequire94c2")
